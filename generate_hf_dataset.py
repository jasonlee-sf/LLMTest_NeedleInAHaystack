...
class LLMNeedleHaystackTester:
    ...
    def run_test(self):
        ...
        for context_length in self.context_lengths:
            for depth_percent in self.document_depth_percents:
                threads.append(
                    threading.Thread(target=self.generate_context, args=(context_length, depth_percent))
                )
    ...
    def generate_context(self, context_length, depth_percent):
        ...
        path = f"/export/home/scr/LLMTest_NeedleInAHaystack/json_haystacks_128k/{context_length:06}_{depth_percent:03}.json"
